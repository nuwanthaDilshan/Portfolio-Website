                ...
                <div className="container mx-auto px-5 grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-gray-100">
                    ...
                    <div className="space-y-6 text-center md:text-left md:pr-10">
                        ...
                        <p className="text-gray-200 text-base md:text-lg leading-relaxed">
                            Discover who we are, what we stand for, and how we
                            are shaping the future with innovative solutions and
                            creative ideas.
                        </p>
                        <p className="text-gray-300 text-sm md:text-base leading-relaxed">
                            Our commitment to excellence drives us to deliver
                            products and services that make a difference. Join
                            us on this incredible adventure.
                        </p>
                        <div>
                            <button className="border border-blue-500 bg-blue-500 text-white font-semibold px-6 py-3 rounded-xl hover:bg-black hover:border-white transition-all">
                                Learn More
                            </button>
                        </div>
                    </div>
